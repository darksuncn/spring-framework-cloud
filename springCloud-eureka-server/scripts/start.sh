...
DEPLOY_DIR="/home/ifp/app/springCloud-eureka-server"
export DEPLOY_DIR
...
EXEC_CMDLINE="${JAVA_HOME}/bin/java ${JAVA_OPTIONS} -classpath $CONF_DIR:$LIB_JARS com.darksun.springCloud.EurekaServerApplication"

if [ -z "$1" ]; then

  EXEC_CMDLINE="${JAVA_HOME}/bin/java ${JAVA_VM} ${GC_OPTS} ${JAVA_DEBUG} ${JAVA_OPTIONS} -classpath $CONF_DIR:$LIB_JARS com.darksun.springCloud.EurekaServerApplication"
  echo "."
